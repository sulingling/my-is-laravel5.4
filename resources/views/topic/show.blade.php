...
<div class="col-sm-8">
    <blockquote>
        <p>{{$topicInfo->name}}</p>
        <footer>文章：{{$topicInfo->post_topics_count}}</footer>
        <button class="btn btn-default topic-submit" data-toggle="modal" data-target="#topic_submit_modal" topic-id="{{$topicInfo->top_id}}" type="button">投稿</button>
    </blockquote>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/topic/{{$topicInfo->top_id}}/submit" method="POST">
                    {{csrf_field()}}
